	...
	<div>
		...
		<table class="container">
			...
			<tr>
					...
					<th style="width: 3em;"><h1>Id</h1></th>
					<th><h1>Name</h1></th>
					<th><h1>Chemical Composition</h1></th>
					<th><h1>Target Ailment</h1></th>
					<th><h1>Pharmacy Name</h1></th>
					<th style="width: 7em;"><h1>Date Of Expiry</h1></th>
					<th><h1>Stock</h1></th>
				</tr>
			</thead>
			<tbody>
			<c:forEach items="${medicineStockList}" var="medicineStock">
				<tr>
					...
					<td class="text-center"><h2>${medicineStock.numberOfTabletsInStock}</h2></td>
				</tr>
